...
To use Dragonboat, make sure to import the package __github.com/lni/dragonboat/v3__. Also add "github.com/dan-j-d/dragonboat/v3 v3.3.0" to the __require__ section of your project's go.mod file.
